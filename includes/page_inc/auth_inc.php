...
function allatthecho($login,$moren_exist,$rowarr,$userid){
global $dbconnect;
    if($login==0){
        $returntxt="";
        return $returntxt;
...
<script type="text/javascript" src="../../resources/js/auth.js.php"></script>
            ...
            <div id="manage-security" class="manage-security">
                        <div id="dashboard" class="dashboard">
                            ...
                            <div class="auth-info-box">
                                ...
                                <div class="section actions"><ul><li class="remove-authenticator"><a class="icon-delete" href="<?php echo SITEHOST."delauth.php?authid=".$row['auth_id'];?>" onclick="if(confirm('提交后将删除这枚安全令，除重新添加外无其他恢复方法，确定吗？'))return true;else return false;">
                                        删除这枚安全令
            ...
            <div id="lobby-games">
                <div id="games-list"> 
                    ...
                    <ul id="game-list-wow" style="display: none;">
                        <?php echo allatthecho($logincheck,$auth_moren_exist,$row,$user_id);
